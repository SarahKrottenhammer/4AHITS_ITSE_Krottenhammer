...
### Python Skript analysieren
Auf Website "exploit-db.com" findet man die Exploit Database. Wenn man in der Suchleiste "vsftpd" eingibt, kommt man zum gesuchten Python Skript 	"vsftpd 2.3.4 - Backdoor Command Execution", das man in Folge analysiert.   
![](https://github.com/user-attachments/assets/c8f9fdd5-1ff0-42ee-85c9-e1d6120ab82a)

Skript analysieren:   
![](https://github.com/user-attachments/assets/311e4518-05d1-44dc-892f-890978df4ad1)   
Der FTP‑Server öffnet automatisch eine Root‑Shell auf Port 6200, wenn sich ein Benutzername mit :) anmeldet.   
:) triggert das Backdoor.    
Das Skript führt einen FTP-Login durch, der den Banner liest und User und Passwort sendet. Währenddessen öffnet der Server im Hintergrund eine shell.

### Sicherheitslücke mit nc ausnutzen
Manuell per netcad am FTP-Server anmelden:   
![](https://github.com/user-attachments/assets/fe46184d-035c-460a-a15d-13915af29ecf)


Ich konnte nicht weiter herausfinden, wie man mit netcat das Backdoor ausnutzt, da dann der Unterricht endete.
