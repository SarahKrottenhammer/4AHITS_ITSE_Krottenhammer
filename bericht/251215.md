...
**Angabe:**   
Führe einen online password guessing attack auf den ftp Port von Metasploitable aus. Verwende dafür hydra ein geeignetes und bereits in Kali installiertes Penetration Testing Tool.
...
Befehl:   
```
hydra -V -l ~/Desktop/usernames.txt -p ~/Desktop/passwords.txt -u 192.168.17.51 ftp
```
-> funktioniert nicht 
