...
### Suche nach einem passenden Metasploit-Modul   
In der msfconsole:   
`search scanner ftp`   

Man findet das relevante Modul:   
`auxiliary/scanner/ftp/ftp_version`

### Modul verwenden   
Befehl: `use auxiliary/scanner/ftp/ftp_version`

Optionen anzeigen und setzen:    
![](https://github.com/user-attachments/assets/f1736a83-1f60-4e8f-82ce-b7fff14c7e37)   

Dann Modul mittels `run` ausführen.   

### Ergebnis   
![](https://github.com/user-attachments/assets/7acc02a6-6fc4-4d32-881e-58d36e972b7e)

Das Modul gibt folgende Informationen aus:   
- Dienst: FTP
- FTP Server: vsFTPd
- Version: 2.3.4

Man erkennt: Die ermittelte Version stimmt mit dem nmap-Scan überein.
