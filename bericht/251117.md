...
Standardmäßig scannt Nmap 1000 der am häufigsten verwendeten TCP-Ports, es sei denn, man gibt die Optionen `-p-` oder `--top-ports N` an. Daher werden hier die 1000 der am häufigsten verwendeten TCP-Ports gescannt.    

Befehl für Metasploitable scannen:   
```
