...
PortScan auf das Kali Linux im Labornetz 5.   
PortScan eingeschränkt auf die Ports 1-50, da es sonst ewig lädt.   
![](https://github.com/user-attachments/assets/0cadf23f-a7b1-4a01-a6e2-5217148cbe4e)   


#### Auf einem Windows System
Auf mein Windows-System 192.168.17.50   
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>-oN &lt;Datei&gt;</td>
      <td>Output in Datei (Normalformat)</td>
...
<th>Option</th>
<th>Bedeutung</th>
<th>Beispiel / Hinweis für Metasploitable</th>
</tr>
</thead>
<tbody>
<tr>
...
<td>Praktisch, wenn ICMP/Ping blockiert wird. Nmap scannt alle Ports der Metasploitable VM.</td>
</tr>
<tr>
<td><code>-sS</code></td>
...
```
map -Pn -sS -sV -sC -oN nmap_default.txt 192.168.17.51
```
